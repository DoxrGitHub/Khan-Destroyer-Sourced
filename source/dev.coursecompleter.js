...
<html>
  ...
  <body>
    ...
    <br>
    <input id="url" placeholder="a course url">
    <button id="btn" onclick="window.newE(document.getElementById('url').value)">Start Coursecompleter</button>
  </body>
</html>
`;

function makeAndInject(e, script) {
